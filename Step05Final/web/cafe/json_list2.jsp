...
<%@ page import="org.json.JSONWriter"%><%@ page import="org.json.JSONObject"%>
...
<%
    ...
    //위에서 계산되거나 얻어낸 값을 JsonCafeDto 객체에 담는다.
    // JsonCafeDto jsonDto = new JsonCafeDto();
    // jsonDto.setList(list);
    // jsonDto.setPageNum(pageNum);
    // jsonDto.setStartPageNum(startPageNum);
    // jsonDto.setEndPageNum(endPageNum);
    // jsonDto.setTotalPageCount(totalPageCount);
